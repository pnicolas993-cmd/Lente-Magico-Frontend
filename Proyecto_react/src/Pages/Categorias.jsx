...
const FormularioCategoria = ({ titulo, onAccion, onCancelar, formData, handleChangeForm, categoriaEditando }) => (
    ...
    return (
        <>
            ...
            <div className="container py-4">
                ...
                {/* Formulario agregar (Pasamos estados como props) */}
                {mostrarAgregar && (
                    <FormularioCategoria
                ...
                {/* Formulario editar (Pasamos estados como props) */}
                {categoriaEditando && (
                    <FormularioCategoria
